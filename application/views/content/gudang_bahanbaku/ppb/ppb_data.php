                        ...
                        <div class="row align-items-center">
                            <div class="col-md-12">
                                ...
                                <ul class="breadcrumb">
                                    ...
                                    <li class="breadcrumb-item"><a href="<?= base_url('gudang_bahanbaku/gudang_bahan_baku_ppb') ?>">PBB</a></li>
                                </ul>
                            </div>
                        </div>
                    </div>
                            ...
                            <div class="col-xl-12">
                                <div class="card">
                                    <div class="card-header">
                                        <h5>Data PPB Gudang Bahan Baku</h5>
            ...
            <div class="row">
              ...
              <div class="col-md-3">
                <div class="form-group">
                  ...
                  <input type="text" class="form-control" id="departement" name="departement" value="<?= $this->session->userdata("departement") ?>" autocomplete="off" readonly>
                </div>
              </div>
              <div class="col-md-3">
                <div class="form-group">
