  ...
  <div class="modal fade" id="add" tabindex="-1" aria-hidden="true">
    <div class="modal-dialog modal-xl">
      <div class="modal-content">
        ...
        <form method="post" id="Formadd" action="<?= base_url() ?>ppb/ppb/add">
  ...
  <script type="text/javascript">
    $(document).ready(function() {
      ...
      $('#input').on('click', function() {
        ...
        const jumlahFormatted = $('#jumlah').val();
        ...
        <input type="hidden" name="jumlah[]" value="${jumlahInteger}">
        ...
        <td>${stok}</td>
        <td></td>
        <td>${jumlahFormatted}</td> <!-- tampil format ribuan -->
        <td class="text-right">
  ...
  <script type="text/javascript">
    $(document).ready(function() {
      ...
      <tr>
        ...
        <!-- integer untuk server -->
        <input type="hidden" class="jumlah-int" name="jumlah[]" value="${jumlah}">

        <!-- input tampilan untuk user -->
        <td>
          <input type="text"
                 class="form-control jumlah-format"
                 value="${jmlFormatted}">
        </td>
