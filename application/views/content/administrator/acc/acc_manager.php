                        ...
                        <div class="row align-items-center">
                            <div class="col-md-12">
                                ...
                                <ul class="breadcrumb">
                                    ...
                                    <li class="breadcrumb-item"><a href="<?= base_url('administrator/acc/acc_manager') ?>">Acc Manager</a></li>
                                </ul>
                            </div>
                        </div>
                    </div>
                                                            ...
                                                            <td class="text-center">
                                                              ...
                                                              <?php endif; ?>
                                                                <?php if ($k['acc_pm'] == null && $k['acc_manager'] == 'Approved') { ?>
                                                                    <div class="btn-group" role="group" aria-label="Basic example">
                                                                        <a type="button" class="btn btn-danger btn-square text-light btn-sm" href="<?= base_url() ?>administrator/acc/acc_manager/delete/<?= $k['no_ppb'] ?>" onclick="if (! confirm('Apakah Anda Yakin?')) { return false; }">
        ...
        <div class="modal-body">
          ...
          <div class="col-md-3">
              <div class="form-group">
                ...
                <input type="text" class="form-control" id="v-nama_admin" name="nama_admin" placeholder="" readonly>
              </div>
          </div>
          </div>
        </div>
...
<div class="modal fade" id="edit" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
  <div class="modal-dialog modal-xl">
    <div class="modal-content">
      ...
      <form method="post" action="<?= base_url('administrator/acc/acc_manager/update') ?>">
        <div class="modal-body">
          ...
          <div class="row mt-3">
            ...
            <div class="col-md-3">
              ...
              <input type="text" class="form-control" id="e-nama_admin" value="<?= $this->session->userdata("nama_operator") ?>" readonly>
            </div>
          </div>  
        </div>
        <div class="modal-footer">
...
<!-- Modal Edit -->
<div class="modal fade" id="edit_pc" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
  <div class="modal-dialog modal-xl">
    <div class="modal-content">
      <div class="modal-header">
...
<script type="text/javascript">
  $(document).ready(function() {
    ...
    // ========== LOAD DATA SAAT MODAL DIBUKA ==========
    $(document).on('show.bs.modal', '#edit_pc', function(event) {
      var btn = $(event.relatedTarget);
      var no_ppb = btn.data('no_ppb');
      var jenis_ppb = btn.data('jenis_ppb');
      var form_ppb = btn.data('jenis_form_ppb');
