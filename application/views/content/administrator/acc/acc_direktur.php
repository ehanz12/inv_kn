                        ...
                        <div class="row align-items-center">
                            <div class="col-md-12">
                                ...
                                <ul class="breadcrumb">
                                    ...
                                    <li class="breadcrumb-item"><a href="<?= base_url('administrator/acc/acc_direktur') ?>">Acc Direktur</a></li>
                                </ul>
                            </div>
                        </div>
                    </div>
                                                    ...
                                                    ?>
                                                        <tr>
                                                            ...
                                                            <td class="text-center">
                                                              <?php if($k['acc_manager'] == 'Approved' && $k['acc_direktur'] == null) :  ?>
                                                              ...
                                                              <?php endif; ?>
                                                                <?php if ($k['acc_direktur'] == 'Approved') { ?>
                                                                    <div class="btn-group" role="group" aria-label="Basic example">
                                                                        <a type="button" class="btn btn-danger btn-square text-light btn-sm" href="<?= base_url() ?>administrator/acc/acc_direktur/delete/<?= $k['no_ppb'] ?>" onclick="if (! confirm('Apakah Anda Yakin?')) { return false; }">
...
<div class="modal fade" id="edit" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
  <div class="modal-dialog modal-xl">
    <div class="modal-content">
      ...
      <form method="post" action="<?= base_url('administrator/acc/acc_direktur/update') ?>">
        <div class="modal-body">
