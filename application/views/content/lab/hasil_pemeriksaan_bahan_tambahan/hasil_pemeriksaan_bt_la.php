                            ...
                            <div class="col-xl-12">
                                <div class="card">
                                    <div class="card-header">
                                        ...
                                        <h5><b>Bahan Tambahan (Lecithin Adlec)</b></h5> <br>
                                        <div class="btn-group">
                                                    ...
                                                    ?>
                                                        <tr>
                                                            ...
                                                            <?php if ($k['status'] === "Proses") { ?>
                                                                    <div class="btn-group" role="group" aria-label="Basic example">
                                                                        <button type="button" class="btn btn-primary btn-square btn-sm" data-toggle="modal" data-target="#edit_ujila" data-id_ujibt="<?= $k['id_ujibt'] ?>" data-id_pb="<?= $k['id_pb'] ?>" data-id_barang="<?= $k['id_barang'] ?>" data-id_supplier="<?= $k['id_supplier'] ?>" data-no_batch="<?= $k['no_batch'] ?>" data-no_surat_jalan="<?= $k['no_surat_jalan'] ?>" data-tgl="<?= $tgl_msk ?>" data-tgl_uji="<?= $tgl_uji ?>" data-no_analis="<?= $k['no_analis'] ?>" data-nama_barang="<?= $k['nama_barang'] ?>" data-nama_supplier="<?= $k['nama_supplier'] ?>" data-op_gudang="<?= $k['op_gudang'] ?>" data-dok_pendukung="<?= $k['dok_pendukung'] ?>" data-jenis_kemasan="<?= $k['jenis_kemasan'] ?>" data-jml_kemasan="<?= $k['jml_kemasan'] ?>" data-ditolak_kemasan="<?= $k['ditolak_kemasan'] ?>" data-qty="<?= $k['qty'] ?>" data-ditolak_qty="<?= $k['ditolak_qty'] ?>" data-exp="<?= $tgl_exp ?>" data-mfg="<?= $tgl_mfg ?>" data-tutup="<?= $k['tutup'] ?>" data-wadah="<?= $k['wadah'] ?>" data-label="<?= $k['label'] ?>" data-pemerian="<?= $k['pemerian'] ?>" data-kelarutan="<?= $k['kelarutan'] ?>" data-viscosity="<?= $k['viscosity'] ?>" data-identifikasi="<?= $k['identifikasi'] ?>" data-ang_lempeng_tot="<?= $k['ang_lempeng_tot'] ?>" data-kondisi_py="<?= $k['kondisi_py'] ?>" data-penguji="<?= $k['penguji'] ?>">
                                                            ...
                                                            <td class="text-center">
                                                                ...
                                                                <?php if ($k['status'] === "Di Tolak") { ?>
                                                                    <div class="btn-group" role="group" aria-label="Basic example">
                                                                        <a type="button" class="btn btn-danger btn-square btn-sm text-light" onclick="window.open(`<?= base_url() ?>lab/Hasil_pemeriksaan_lab/Bahan_tambahan/Hasil_pemeriksaan_bt_la/pdf_label_reject/<?= str_replace('/', '--', $k['no_surat_jalan']) ?>`, 'location=yes,height=700,width=1300,scrollbars=yes,status=yes'); " data-id_pb="<?= $k['id_pb'] ?>" data-no_batch="<?= $k['no_batch'] ?>" data-no_surat_jalan="<?= $k['no_surat_jalan'] ?>">
                                                                            <i class="feather icon-file"></i>Print Label
                                                                        </a>
                                                                    </div>
                                                                <?php } ?>
                                                                <?php if ($k['status'] === "Released" || $k['status'] === "Di Tolak") { ?>
                                                                    <div class="btn-group" role="group" aria-label="Basic example">
                                                                        <a type="button" class="btn btn-warning btn-square btn-sm text-light" onclick="window.open(`<?= base_url() ?>lab/Hasil_pemeriksaan_lab/Bahan_tambahan/Hasil_pemeriksaan_bt_la/pdf_label_hasil/<?= str_replace('/', '--', $k['no_surat_jalan']) ?>`, 'location=yes,height=700,width=1300,scrollbars=yes,status=yes'); " data-id_pb="<?= $k['id_pb'] ?>" data-no_batch="<?= $k['no_batch'] ?>" data-no_surat_jalan="<?= $k['no_surat_jalan'] ?>">
    ...
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="exampleModalLabel">Detail Hasil Pemeriksaan Bahan Tambahan<br><b>(Lecithin Adlec)</b></h5>
                ...
                <div class="row">
                    ...
                    <div class="col-md-4">
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control" id="v-viscosity" name="viscosity" placeholder="Viscosity" readonly>
                        </div>
                    </div>
                    <div class="col-md-4">
                        <div class="form-group">
                    ...
                    <div class="col-md-4">
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control" id="v-ang_lempeng_tot" name="ang_lempeng_tot" placeholder="Angka Lempeng Total" readonly>
                        </div>
                    </div>
                    <div class="col-md-4">
                        <div class="form-group">
    ...
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
            <div class="modal-header">
                ...
                <form method="post" action="<?= base_url() ?>lab/Hasil_pemeriksaan_lab/Bahan_tambahan/Hasil_pemeriksaan_bt_la/add">
            ...
            <div class="modal-body">
                ...
                <div class="row">
                    ...
                    <div class="col-md-4">
                        <div class="form-group">
                            <label for="viscosity" class="mt-2">Viscosity</label>
                            <input type="text" class="form-control" id="r-viscosity" name="viscosity" placeholder="Viscosity" readonly>
                        </div>
                    </div>
                    <div class="col-md-4">
                        <div class="form-group">
                    ...
                    <div class="col-md-4">
                        <div class="form-group">
                            <label for="ang_lempeng_tot" class="mt-2">Angka Lempeng Total</label>
                            <input type="text" class="form-control" id="r-ang_lempeng_tot" name="ang_lempeng_tot" placeholder="Angka Lempeng Total" readonly>
                        </div>
                    </div>
                    <div class="col-md-4">
                        <div class="form-group">
    ...
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
            <div class="modal-header">
                ...
                <form method="post" action="<?= base_url() ?>lab/Hasil_pemeriksaan_lab/Bahan_tambahan/Hasil_pemeriksaan_bt_la/ditolak">
            ...
            <div class="modal-body">
                ...
                <div class="row">
                    ...
                    <div class="col-md-4">
                        <div class="form-group">
                            <label for="viscosity" class="mt-2">Viscosity</label>
                            <input type="text" class="form-control" id="t-viscosity" name="viscosity" placeholder="Viscosity" readonly>
                        </div>
                    </div>
                    <div class="col-md-4">
                        <div class="form-group">
                    ...
                    <div class="col-md-4">
                        <div class="form-group">
                            <label for="ang_lempeng_tot" class="mt-2">Angka Lempeng Total</label>
                            <input type="text" class="form-control" id="t-ang_lempeng_tot" name="ang_lempeng_tot" placeholder="Angka Lempeng Total" readonly>
                        </div>
                    </div>
                    <div class="col-md-4">
                        <div class="form-group">
...
<script type="text/javascript">
    $(document).ready(function() {
        $('#detail').on('show.bs.modal', function(event) {
            ...
            var viscosity = $(event.relatedTarget).data('viscosity')
            var identifikasi = $(event.relatedTarget).data('identifikasi')
            var ang_lempeng_tot = $(event.relatedTarget).data('ang_lempeng_tot')
            ...
            $(this).find('#v-viscosity').val(viscosity)
            $(this).find('#v-identifikasi').val(identifikasi)
            $(this).find('#v-ang_lempeng_tot').val(ang_lempeng_tot)
...
<script type="text/javascript">
    $(document).ready(function() {
        $('#released').on('show.bs.modal', function(event) {
            ...
            $(this).find('#r-viscosity').val(viscosity)
            $(this).find('#r-identifikasi').val(identifikasi)
            $(this).find('#r-ang_lempeng_tot').val(ang_lempeng_tot)
...
<script type="text/javascript">
    $(document).ready(function() {
        $('#reject').on('show.bs.modal', function(event) {
            ...
            $(this).find('#t-viscosity').val(viscosity)
            $(this).find('#t-identifikasi').val(identifikasi)
            $(this).find('#t-ang_lempeng_tot').val(ang_lempeng_tot)
...
<?php
$this->view('content/lab/pemeriksaan_bahan_tambahan/lecithinadlec_edit');
?>