                                                    ...
                                                    ?>
                                                        <tr>
                                                            ...
                                                            <?php if ($k['status'] === "Proses") { ?>
                                                                    <div class="btn-group" role="group" aria-label="Basic example">
                                                                        <button type="button" class="btn btn-primary btn-square btn-sm" data-toggle="modal" data-target="#edit_ujitd" data-id_ujibt="<?= $k['id_ujibt'] ?>" data-id_pb="<?= $k['id_pb'] ?>" data-id_barang="<?= $k['id_barang'] ?>" data-id_supplier="<?= $k['id_supplier'] ?>" data-no_batch="<?= $k['no_batch'] ?>" data-no_surat_jalan="<?= $k['no_surat_jalan'] ?>" data-tgl="<?= $tgl_msk ?>" data-tgl_uji="<?= $tgl_uji ?>" data-no_analis="<?= $k['no_analis'] ?>" data-nama_barang="<?= $k['nama_barang'] ?>" data-nama_supplier="<?= $k['nama_supplier'] ?>" data-op_gudang="<?= $k['op_gudang'] ?>" data-dok_pendukung="<?= $k['dok_pendukung'] ?>" data-jenis_kemasan="<?= $k['jenis_kemasan'] ?>" data-jml_kemasan="<?= $k['jml_kemasan'] ?>" data-ditolak_kemasan="<?= $k['ditolak_kemasan'] ?>" data-qty="<?= $k['qty'] ?>" data-ditolak_qty="<?= $k['ditolak_qty'] ?>" data-exp="<?= $tgl_exp ?>" data-mfg="<?= $tgl_mfg ?>" data-tutup="<?= $k['tutup'] ?>" data-wadah="<?= $k['wadah'] ?>" data-label="<?= $k['label'] ?>" data-pemerian="<?= $k['pemerian'] ?>" data-kel_h2so4p="<?= $k['kel_h2so4p'] ?>" data-kel_hcip="<?= $k['kel_hcip'] ?>" data-kel_air="<?= $k['kel_air'] ?>" data-identifikasi="<?= $k['identifikasi'] ?>" data-tio2_h2so4="<?= $k['tio2_h2so4'] ?>" data-s_pengeringan="<?= $k['s_pengeringan'] ?>" data-s_pemijaran="<?= $k['s_pemijaran'] ?>" data-kes_pewarna="<?= $k['kes_pewarna'] ?>" data-kondisi_py="<?= $k['kondisi_py'] ?>" data-penguji="<?= $k['penguji'] ?>">
                                                            ...
                                                            <td class="text-center">
                                                                ...
                                                                <?php if ($k['status'] === "Di Tolak") { ?>
                                                                    <div class="btn-group" role="group" aria-label="Basic example">
                                                                        <a type="button" class="btn btn-danger btn-square btn-sm text-light" onclick="window.open(`<?= base_url() ?>lab/Hasil_pemeriksaan_lab/Bahan_tambahan/Hasil_pemeriksaan_bt_td/pdf_label_reject/<?= str_replace('/', '--', $k['no_surat_jalan']) ?>`, 'location=yes,height=700,width=1300,scrollbars=yes,status=yes'); " data-id_pb="<?= $k['id_pb'] ?>" data-no_batch="<?= $k['no_batch'] ?>" data-no_surat_jalan="<?= $k['no_surat_jalan'] ?>">
                                                                            <i class="feather icon-file"></i>Print Label
                                                                        </a>
                                                                    </div>
                                                                <?php } ?>
                                                                <?php if ($k['status'] === "Released" || $k['status'] === "Di Tolak") { ?>
                                                                    <div class="btn-group" role="group" aria-label="Basic example">
                                                                        <a type="button" class="btn btn-warning btn-square btn-sm text-light" onclick="window.open(`<?= base_url() ?>lab/Hasil_pemeriksaan_lab/Bahan_tambahan/Hasil_pemeriksaan_bt_td/pdf_label_hasil/<?= str_replace('/', '--', $k['no_surat_jalan']) ?>`, 'location=yes,height=700,width=1300,scrollbars=yes,status=yes'); " data-id_pb="<?= $k['id_pb'] ?>" data-no_batch="<?= $k['no_batch'] ?>" data-no_surat_jalan="<?= $k['no_surat_jalan'] ?>">
    ...
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="exampleModalLabel">Detail Hasil Pemeriksaan Bahan Tambahan<br><b>(Titanium Dioxide)</b></h5>
            ...
            <div class="modal-body">
                ...
                <div class="row">
                    ...
                    <div class="col-md-12">
                        <div class="form-group">
                            <center><label for="kelarutan"><b>Kelarutan</b></label></center>
                            <div class="row">
                                <div class="col-md-4">
                                    <div class="form-group">
                                        <label for="kel_h2so4p" class="mt-2">Dalam H2 SO4 P</label><br>
                                        <input type="text" class="form-control" id="v-kel_h2so4p" name="kel_h2so4p" placeholder="Kelarutan (Dalam H2 SO4 P)" readonly>
                                    </div>
                                </div>
                                <div class="col-md-4">
                                    <div class="form-group">
                                        <label for="kel_hcip" class="mt-2">Dalam HCI P</label><br>
                                        <input type="text" class="form-control" id="v-kel_hcip" name="kel_hcip" placeholder="Kelarutan (Dalam HCI P)" readonly>
                                    </div>
                                </div>
                                <div class="col-md-4">
                                    <div class="form-group">
                                        <label for="kel_air" class="mt-2">Dalam Air</label><br>
                    ...
                    <div class="col-md-4">
                        <div class="form-group">
                            <label for="tio2_h2so4" class="mt-2">0,5 gr TiO2 + H2SO4</label>
                            <input type="text" class="form-control" id="v-tio2_h2so4" name="tio2_h2so4" placeholder="0,5 gr TiO2 + H2SO4" readonly>
                        </div>
                    </div>
                    <div class="col-md-4">
                        <div class="form-group">
                    ...
                    <div class="col-md-4">
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control" id="v-s_pemijaran" name="s_pemijaran" placeholder="Sisa Pemijaran" readonly>
                        </div>
                    </div>
                    <div class="col-md-4">
                        <div class="form-group">
                            <label for="kes_pewarna" class="mt-2">Kesamaan terhadap pewarna</label>
                            <input type="text" class="form-control" id="v-kes_pewarna" name="kes_pewarna" placeholder="Kesamaan terhadap pewarna" readonly>
                        </div>
                    </div>
                    <div class="col-md-4">
                        <div class="form-group">
    ...
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
            <div class="modal-header">
                ...
                <form method="post" action="<?= base_url() ?>lab/Hasil_pemeriksaan_lab/Bahan_tambahan/Hasil_pemeriksaan_bt_td/add">
            ...
            <div class="modal-body">
                ...
                <div class="row">
                        ...
                        <div class="form-group">
                            ...
                            <div class="row">
                                <div class="col-md-4">
                                    <div class="form-group">
                                        <label for="kel_h2so4p" class="mt-2">Dalam H2 SO4 P</label><br>
                                        <input type="text" class="form-control" id="r-kel_h2so4p" name="kel_h2so4p" placeholder="Kelarutan (Dalam H2 SO4 P)" readonly>
                                    </div>
                                </div>
                                <div class="col-md-4">
                                    <div class="form-group">
                                        <label for="kel_hcip" class="mt-2">Dalam HCI P</label><br>
                                        <input type="text" class="form-control" id="r-kel_hcip" name="kel_hcip" placeholder="Kelarutan (Dalam HCI P)" readonly>
                                    </div>
                                </div>
                                <div class="col-md-4">
                                    <div class="form-group">
                    ...
                    <div class="col-md-4">
                        <div class="form-group">
                            <label for="tio2_h2so4" class="mt-2">0,5 gr TiO2 + H2SO4</label>
                            <input type="text" class="form-control" id="r-tio2_h2so4" name="tio2_h2so4" placeholder="0,5 gr TiO2 + H2SO4" readonly>
                        </div>
                    </div>
                    <div class="col-md-4">
                        <div class="form-group">
                    ...
                    <div class="col-md-4">
                        <div class="form-group">
                            <label for="s_pemijaran" class="mt-2">Sisa Pemijaran</label>
                            <input type="text" class="form-control" id="r-s_pemijaran" name="s_pemijaran" placeholder="Sisa Pemijaran" readonly>
                        </div>
                    </div>
                    <div class="col-md-4">
                        <div class="form-group">
                            <label for="kes_pewarna" class="mt-2">Kesamaan terhadap pewarna</label>
                            <input type="text" class="form-control" id="r-kes_pewarna" name="kes_pewarna" placeholder="Kesamaan terhadap pewarna" readonly>
                        </div>
                    </div>
                    <div class="col-md-4">
                        <div class="form-group">
    ...
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
            <div class="modal-header">
                ...
                <form method="post" action="<?= base_url() ?>lab/Hasil_pemeriksaan_lab/Bahan_tambahan/Hasil_pemeriksaan_bt_td/ditolak">
            ...
            <div class="modal-body">
                ...
                <div class="row">
                        ...
                        <div class="form-group">
                            ...
                            <div class="row">
                                <div class="col-md-4">
                                    <div class="form-group">
                                        <label for="kel_h2so4p" class="mt-2">Dalam H2 SO4 P</label><br>
                                        <input type="text" class="form-control" id="t-kel_h2so4p" name="kel_h2so4p" placeholder="Kelarutan (Dalam H2 SO4 P)" readonly>
                                    </div>
                                </div>
                                <div class="col-md-4">
                                    <div class="form-group">
                                        <label for="kel_hcip" class="mt-2">Dalam HCI P</label><br>
                                        <input type="text" class="form-control" id="t-kel_hcip" name="kel_hcip" placeholder="Kelarutan (Dalam HCI P)" readonly>
                                    </div>
                                </div>
                                <div class="col-md-4">
                                    <div class="form-group">
                    ...
                    <div class="col-md-4">
                        <div class="form-group">
                            <label for="tio2_h2so4" class="mt-2">0,5 gr TiO2 + H2SO4</label>
                            <input type="text" class="form-control" id="t-tio2_h2so4" name="tio2_h2so4" placeholder="0,5 gr TiO2 + H2SO4" readonly>
                        </div>
                    </div>
                    <div class="col-md-4">
                        <div class="form-group">
                    ...
                    <div class="col-md-4">
                        <div class="form-group">
                            <label for="s_pemijaran" class="mt-2">Sisa Pemijaran</label>
                            <input type="text" class="form-control" id="t-s_pemijaran" name="s_pemijaran" placeholder="Sisa Pemijaran" readonly>
                        </div>
                    </div>
                    <div class="col-md-4">
                        <div class="form-group">
                            <label for="kes_pewarna" class="mt-2">Kesamaan terhadap pewarna</label>
                            <input type="text" class="form-control" id="t-kes_pewarna" name="kes_pewarna" placeholder="Kesamaan terhadap pewarna" readonly>
                        </div>
                    </div>
                    <div class="col-md-4">
                        <div class="form-group">
...
<?php
$this->view('content/lab/pemeriksaan_bahan_tambahan/titaniumdioxide_edit');
?>