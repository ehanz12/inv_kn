<!-- Modal Uji Pewarna -->
<div class="modal fade" id="add_ujitd" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="exampleModalLabel">Pemeriksaan Uji Bahan Tambahan <br><b>Titanium Dioxide</b></h5>
                <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                    <span aria-hidden="true">&times;</span>
                </button>
            </div>
            <form method="post" action="<?= base_url() ?>lab/Hasil_pemeriksaan_lab/Bahan_tambahan/Hasil_pemeriksaan_bt_td/add_ujitd">
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-4">
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control text-uppercase" id="no_analis_td" name="no_analis" autocomplete="off" placeholder="No. Analisa" required>
                            </div>
                        </div>
                        <div class="col-md-4">
                            <div class="form-group">
                                ...
                                <div class="row">
                                    <div class="col-md-4">
                                        <div class="form-group">
                                            ...
                                            <select class="form-control chosen-select" id="kel_h2so4p" name="kel_h2so4p" required>
                                                <option value="" disabled selected hidden>- Pilih Jenis Hasil -</option>
                                                <option value="Sesuai">Sesuai</option>
                                                <option value="Tidak Sesuai">Tidak Sesuai</option>
                                            </select>
                                    ...
                                    <div class="col-md-4">
                                        <div class="form-group">
                                            ...
                                            <select class="form-control chosen-select" id="kel_hcip" name="kel_hcip" required>
                                                <option value="" disabled selected hidden>- Pilih Jenis Hasil -</option>
                                                <option value="Sesuai">Sesuai</option>
                                                <option value="Tidak Sesuai">Tidak Sesuai</option>
                                            </select>
                                    ...
                                    <div class="col-md-4">
                                        <div class="form-group">
                                            ...
                                            <select class="form-control chosen-select" id="kel_air" name="kel_air" required>
                                                <option value="" disabled selected hidden>- Pilih Jenis Hasil -</option>
                                                <option value="Sesuai">Sesuai</option>
                                                <option value="Tidak Sesuai">Tidak Sesuai</option>
                                            </select>
                        ...
                        <div class="col-md-4">
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control text-uppercase" id="identifikasi_td" name="identifikasi" autocomplete="off" placeholder="Identifikasi" required>
                            </div>
                        </div>
                        <div class="col-md-4">
                            <div class="form-group">
                                <label for="tio2_h2so4" class="mt-2">0,5 gr TiO2 + H2SO4</label>
                                <select class="form-control chosen-select" id="tio2_h2so4" name="tio2_h2so4" required>
                                    <option value="" disabled selected hidden>- Pilih Jenis Hasil -</option>
                                    <option value="Sesuai">Sesuai</option>
                                    <option value="Tidak Sesuai">Tidak Sesuai</option>
                                </select>
                        ...
                        <div class="col-md-4">
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control text-uppercase" id="s_pengeringan_td" name="s_pengeringan" autocomplete="off" placeholder="Susut Pengeringan" required>
                            </div>
                        </div>
                        <div class="col-md-4">
                            <div class="form-group">
                                <label for="s_pemijaran" class="mt-2">Sisa Pemijaran</label>
                                <input type="text" class="form-control text-uppercase" id="s_pemijaran_td" name="s_pemijaran" autocomplete="off" placeholder="Sisa Pemijaran" required>
                            </div>
                        </div>
                        <div class="col-md-4">
                            <div class="form-group">
                                <label for="kes_pewarna" class="mt-2">Kesamaan terhadap pewarna</label>
                                <select class="form-control chosen-select" id="kes_pewarna" name="kes_pewarna" required>
                                    <option value="" disabled selected hidden>- Pilih Jenis Hasil -</option>
                                    <option value="Sesuai">Sesuai</option>
                                    <option value="Tidak Sesuai">Tidak Sesuai</option>
                                </select>
...
<script type="text/javascript">
    ...
    $(document).ready(function() {
        $('#add_ujitd').on('show.bs.modal', function(event) {
            ...
            uppercase('#no_analis_td');
            uppercase('#identifikasi_td');
            uppercase('#s_pengeringan_td');
            uppercase('#s_pemijaran_td');
            checkKoma('#identifikasi_td');
            checkKoma('#s_pengeringan_td');
            checkKoma('#s_pemijaran_td');
        })
    })
</script>