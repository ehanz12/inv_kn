<!-- Modal Uji Pewarna -->
<div class="modal fade" id="add_ujisls" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="exampleModalLabel">Pemeriksaan Uji Bahan Tambahan <br><b>Sodium Launil Sulfat</b></h5>
                <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                    <span aria-hidden="true">&times;</span>
                </button>
            </div>
            <form method="post" action="<?= base_url() ?>lab/Hasil_pemeriksaan_lab/Bahan_tambahan/Hasil_pemeriksaan_bt_sls/add_ujisls">
                <input type="hidden" id="e_id_adm_bm" name="id_adm_bm">
                <input type="hidden" id="e_id_barang" name="id_barang">
                <input type="hidden" id="e_isupplier" name="id_supplier">
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-4">
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control text-uppercase" id="no_analis_sls" name="no_analis" autocomplete="off" placeholder="No. Analisa" required>
                            </div>
                        </div>
                        <div class="col-md-4">
                            <div class="form-group">
                        ...
                        <div class="col-md-4">
                            <div class="form-group">
                                ...
                                <select class="form-control chosen-select" id="identifikasi_ss" name="identifikasi_ss" required>
                                    <option value="" disabled selected hidden>- Pilih Jenis Hasil -</option>
                                    <option value="Sesuai">Sesuai</option>
                                    <option value="Tidak Sesuai">Tidak Sesuai</option>
                                </select>
                        ...
                        <div class="col-md-4">
                            <div class="form-group">
                                <label for="kadar" class="mt-2">Kadar</label><br>
                                <input type="text" class="form-control text-uppercase" id="kadar_sls" name="kadar" autocomplete="off" placeholder="Kadar" required>
                            </div>
                        </div>
                        <div class="col-md-4">
                            <div class="form-group">
...
<script type="text/javascript">
    ...
    $(document).ready(function() {
        $('#add_ujisls').on('show.bs.modal', function(event) {
            ...
            $(this).find('#e_id_barang').val(id_prc_master_barang)
            $(this).find('#e_isupplier').val(id_supplier)
