<!-- Modal Uji Pewarna -->
<div class="modal fade" id="add_ujimp" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="exampleModalLabel">Pemeriksaan Uji Bahan Tambahan <br><b>Methyl Paraben</b></h5>
                <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                    <span aria-hidden="true">&times;</span>
                </button>
            </div>
            <form method="post" action="<?= base_url() ?>lab/Hasil_pemeriksaan_lab/Bahan_tambahan/Hasil_pemeriksaan_bt_mp/add_ujimp">
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-4">
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control text-uppercase" id="no_analis_mp" name="no_analis" autocomplete="off" placeholder="No. Analisa" required>
                            </div>
                        </div>
                        <div class="col-md-4">
                            <div class="form-group">
                        ...
                        <div class="col-md-4">
                            <div class="form-group">
                                ...
                                <select class="form-control chosen-select" id="jarak_lebur" name="jarak_lebur" required>
                                    <option value="" disabled selected hidden>- Pilih Jenis Hasil -</option>
                                    <option value="Sesuai">Sesuai</option>
                                    <option value="Tidak Sesuai">Tidak Sesuai</option>
                                </select>
                        ...
                        <div class="col-md-4">
                            <div class="form-group">
                                ...
                                <select class="form-control chosen-select" id="keasaman" name="keasaman" required>
                                    <option value="" disabled selected hidden>- Pilih Jenis Hasil -</option>
                                    <option value="Sesuai">Sesuai</option>
                                    <option value="Tidak Sesuai">Tidak Sesuai</option>
                                </select>
                        ...
                        <div class="col-md-4">
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control text-uppercase" id="s_pengeringan_mp" name="s_pengeringan" autocomplete="off" placeholder="Susut Pengeringan" required>
                            </div>
                        </div>
                        <div class="col-md-4">
                            <div class="form-group">
                                <label for="s_pemijaran" class="mt-2">Sisa Pemijaran</label>
                                <input type="text" class="form-control text-uppercase" id="s_pemijaran_mp" name="s_pemijaran" autocomplete="off" placeholder="Sisa Pemijaran" required>
                            </div>
                        </div>
                        <div class="col-md-4">
                            <div class="form-group">
                                <label for="p_kadar" class="mt-2">Penetapan Kadar</label>
                                <input type="text" class="form-control text-uppercase" id="p_kadar_mp" name="p_kadar" autocomplete="off" placeholder="Penetapan Kadar" required>
                            </div>
                        </div>
                        <div class="col-md-4">
                            <div class="form-group">
...
<script type="text/javascript">
    ...
    $(document).ready(function() {
        $('#add_ujimp').on('show.bs.modal', function(event) {
            ...
            uppercase('#no_analis_mp');
            uppercase('#s_pengeringan_mp');
            uppercase('#s_pemijaran_mp');
            uppercase('#p_kadar_mp');
            checkKoma('#s_pengeringan_mp');
            checkKoma('#s_pemijaran_mp');
            checkKoma('#p_kadar_mp');
        })
    })
</script>