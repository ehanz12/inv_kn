            ...
            <div class="row align-items-center">
              <div class="col-md-12">
                ...
                <ul class="breadcrumb">
                  ...
                  <li class="breadcrumb-item"><a href="<?= base_url('melting/Barang_masuk_melting/Bm_bahan_tambahan/Mm_bt_nb') ?>">Barang Masuk Melting</a></li>
                </ul>
              </div>
            </div>
          </div>
                  ...
                  <div class="card-header">
                    ...
                    <div class="btn-group">
                      ...
                      <div class="dropdown-menu scrollable-menu" role="menu">
                        ...
                        <a class="dropdown-item" href="<?= base_url('melting/Barang_masuk_melting/Bm_bahan_tambahan/mm_bt_sb') ?>">Sodium Benzoat</a>
                      </div>
                    </div><br>
                  </div>
