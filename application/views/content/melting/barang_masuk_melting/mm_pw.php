            ...
            <div class="row align-items-center">
              <div class="col-md-12">
                ...
                <ul class="breadcrumb">
                  ...
                  <li class="breadcrumb-item"><a href="<?= base_url('melting/Barang_masuk_melting/Mm_pw') ?>">Barang Masuk Melting</a></li>
                </ul>
              </div>
            </div>
          </div>
        ...
        <div class="row">
          ...
          <div class="col-md-4">
            <div class="form-group">
              ...
              <input type="text" class="form-control" id="v-tgl" name="v-tgl" placeholder="Tanggal Masuk" maxlength="20" readonly>
            </div>
          </div>
          <div class="col-md-4">
            <div class="form-group">
