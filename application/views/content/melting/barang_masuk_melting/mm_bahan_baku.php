            ...
            <div class="row align-items-center">
              <div class="col-md-12">
                ...
                <ul class="breadcrumb">
                  ...
                  <li class="breadcrumb-item"><a href="<?= base_url('melting/Barang_masuk_melting/Mm_bahan_baku') ?>">Barang Masuk Melting</a></li>
                </ul>
              </div>
            </div>
          </div>
...
<script type="text/javascript">
  $(document).ready(function() {
    $('#menu').find('click', function() {
      const jenis_bahan = $(this).text();
      console.log(jenis_bahan);
    })
    // $('#bahan_baku').on('click', function() {
    //   const bahan_baku = $(this).text();
    //   console.log(bahan_baku);
    // })
    // $('#pelarut').on('click', function() {
    //   const pelarut = $(this).text();
    //   console.log(pelarut);
    // })
...
<div class="modal fade" id="edit" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
  <div class="modal-dialog modal-lg">
    <div class="modal-content">
      ...
      <form method="post" action="<?= base_url() ?>melting/barang_masuk/update">
