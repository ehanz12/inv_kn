...
ORDER BY a.tgl_masak ASC";
    ...
    {
        $sql = "
        SELECT a.*,c.nama_barang,c.jenis_gel FROM tb_mlt_masak_gelatin a
    ...
    public function add($data)
    {
        ...
        $sql = "
        INSERT INTO `tb_mlt_masak_gelatin`(`id_ts_melt`, `tgl_masak`, `shift`, `batch_masak`,`id_mm`,`jml_bahan`,`jml_air`,`temp_pel`,`jam_gel`,`jam_bt`,`mixing1`,`mixing2`,`vac1`,`vac2`,`scala_vac`,`visco_cps`,`visco_c`,`suhu_ruang`,`kel_ruang`,`keb_melter`,`label_bersih`,`op1`,`op2`,`supervisor`,`created_at`, `created_by`, `updated_at`, `updated_by`, `is_deleted`) 
