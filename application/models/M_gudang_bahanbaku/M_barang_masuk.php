...
class M_barang_masuk extends CI_Model
{
    ...
    public function add($data)
    {
        ...
        $sql = "
        INSERT INTO `tb_gbb_barang_masuk`(`id_barang`, `id_supplier`,`no_batch`,`no_surat_jalan`, `tgl`,`op_gudang`, `dok_pendukung`, `jenis_kemasan`, `jml_kemasan`,`ditolak_kemasan`, `tutup`, `wadah`, `label`, `qty`,`stok`,`ditolak_qty`,`exp`, `mfg`,`created_at`, `created_by`, `updated_at`, `updated_by`, `is_deleted`) 
