...
class M_hasil_pemeriksaan_pel extends CI_Model
{
    ...
    public function add_ujipel($data)
    {
    ...
    public function update($data)
    {
        ...
        `aroma` = '$data[aroma]',
        `berat_jenis` = '$data[berat_jenis]'
         WHERE `id_ujipel` = '$data[id_ujipel]'
        ";
        return $this->db->query($sql);
    }
    ...
    {
        $sql = "
        SELECT a.*,b.id_pb,b.no_batch,b.tgl,b.status,b.dok_pendukung,b.op_gudang,b.jenis_kemasan,b.jml_kemasan,b.jml_kemasan,b.qty,b.exp,b.mfg,b.tutup,b.wadah,b.label,c.nama_supplier,d.nama_barang,d.satuan,d.qty_pack FROM tb_lab_hasil_ujipel a
    ...
    {
        $sql = "
        SELECT a.*,b.id_pb,b.no_batch,b.tgl,b.status,b.dok_pendukung,b.op_gudang,b.jenis_kemasan,b.jml_kemasan,b.jml_kemasan,b.qty,b.exp,b.mfg,b.tutup,b.wadah,b.label,c.nama_supplier,d.nama_barang,d.satuan,d.nama_produsen,d.negara_produsen,d.jenis_gel FROM tb_lab_hasil_ujipel a
        LEFT JOIN tb_lab_pemeriksaan_bahan b ON a.id_barang = b.id_barang
        LEFT JOIN tb_prc_supplier c ON a.id_supplier = c.id_supplier
        LEFT JOIN tb_prc_barang d ON a.id_barang = d.id_barang
            WHERE a.is_deleted = 0 AND b.no_surat_jalan = '$no_surat_jalan' ORDER BY a.tgl_uji ASC";
