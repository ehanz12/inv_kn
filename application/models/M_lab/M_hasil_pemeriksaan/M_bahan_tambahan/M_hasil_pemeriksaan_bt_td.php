...
class M_hasil_pemeriksaan_bt_td extends CI_Model
{
    ...
    public function add_ujitd($data)
    {
        $id_user = $this->id_user();
        $sql = "
        INSERT INTO `tb_lab_hasil_ujibt_titaniumdioxide`(`id_adm_bm`,`id_prc_master_barang`,`id_supplier`,`tgl_uji`,`no_analis`,`penguji`,`pemerian`,`kel_h2so4p`,`kel_hcip`,`kel_air`,`identifikasi`,`tio2_h2so4`,`s_pengeringan`,`s_pemijaran`,`kes_pewarna`,`kondisi_py`) 
        VALUES ('$data[id_adm_bm]','$data[id_barang]','$data[id_supplier]','$data[tgl_uji]','$data[no_analis]','$data[nama_operator]','$data[pemerian]','$data[kel_h2so4p]','$data[kel_hcip]','$data[kel_air]','$data[identifikasi]','$data[tio2_h2so4]','$data[s_pengeringan]','$data[s_pemijaran]','$data[kes_pewarna]','$data[kondisi_py]')
        ";
        return $this->db->query($sql);
    }
    ...
    public function update($data)
    {
        $id_user = $this->id_user();
        $sql = "
        UPDATE `tb_lab_hasil_ujibt_titaniumdioxide`
        SET 
        `id_pb` = '$data[id_pb]',
    ...
    {
        $sql = "
        SELECT a.*,b.id_pb,b.no_batch,b.tgl,b.status,b.dok_pendukung,b.op_gudang,b.jenis_kemasan,b.jml_kemasan,b.jml_kemasan,b.qty,b.exp,b.mfg,b.tutup,b.wadah,b.label,c.nama_supplier,d.nama_barang,d.satuan,d.qty_pack FROM tb_lab_hasil_ujibt_titaniumdioxide a
    ...
    {
        $sql = "
        SELECT a.*,b.id_pb,b.no_batch,b.tgl,b.status,b.dok_pendukung,b.op_gudang,b.jenis_kemasan,b.jml_kemasan,b.jml_kemasan,b.qty,b.exp,b.mfg,b.tutup,b.wadah,b.label,c.nama_supplier,d.nama_barang,d.satuan,d.nama_produsen,d.negara_produsen FROM tb_lab_hasil_ujibt_titaniumdioxide a
        LEFT JOIN tb_lab_pemeriksaan_bahan b ON a.id_barang = b.id_barang
        LEFT JOIN tb_prc_supplier c ON a.id_supplier = c.id_supplier
        LEFT JOIN tb_prc_barang d ON a.id_barang = d.id_barang
        WHERE a.is_deleted = 0 AND b.no_surat_jalan = '$no_surat_jalan' ORDER BY a.tgl_uji ASC";
