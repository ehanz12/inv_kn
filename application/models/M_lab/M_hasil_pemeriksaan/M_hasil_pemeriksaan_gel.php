...
class M_hasil_pemeriksaan_gel extends CI_Model
{
    ...
    public function get($id = null)
    {
        ...
        $sql = "
            SELECT a.*,b.tgl_bm,b.status_barang,b.id_user AS op_gudang,b.no_batch,b.jml_bm,c.no_sjl, c.tgl_dpb,d.nama_barang,d.jenis_barang FROM tb_lab_hasil_ujigel a
