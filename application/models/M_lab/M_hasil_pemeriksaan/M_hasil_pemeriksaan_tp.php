...
class M_hasil_pemeriksaan_tp extends CI_Model
{
    ...
    public function get($id = null)
    {
        ...
        $sql = "
            SELECT a.*,b.id_adm_bm,b.no_batch,b.id_user AS op_gudang,b.jml_bm,b.status_barang,c.tgl_dpb,c.no_sjl,d.nama_barang,d.jenis_barang FROM tb_lab_hasil_ujitp a
    ...
    public function update($data)
    {
        $id_user = $this->id_user();
        $sql = "
        UPDATE `tb_lab_hasil_ujitp`
        SET 
        `tgl_uji` = '$data[tgl_uji]',
        `no_analis` = '$data[no_analis]',
        `pemerian1` = '$data[pemerian1]',
        `pemerian2` = '$data[pemerian2]',
        `pemerian3` = '$data[pemerian3]',
        `pemerian4` = '$data[pemerian4]',
        `b_bruto1` = '$data[b_bruto1]',
        `b_bruto2` = '$data[b_bruto2]',
        `b_bruto3` = '$data[b_bruto3]',
        `b_bruto4` = '$data[b_bruto4]',
        `kekentalan1` = '$data[kekentalan1]',
        `kekentalan2` = '$data[kekentalan2]',
        `kekentalan3` = '$data[kekentalan3]',
        `kekentalan4` = '$data[kekentalan4]',
        `waktu_p1` = '$data[waktu_p1]',
        `waktu_p2` = '$data[waktu_p2]',
        `waktu_p3` = '$data[waktu_p3]',
        `waktu_p4` = '$data[waktu_p4]',
        `kondisi_sp1` = '$data[kondisi_sp1]',
        `kondisi_sp2` = '$data[kondisi_sp2]',
        `kondisi_sp3` = '$data[kondisi_sp3]',
        `kondisi_sp4` = '$data[kondisi_sp4]',
        `kondisi_py1` = '$data[kondisi_py1]',
        `kondisi_py2` = '$data[kondisi_py2]',
        `kondisi_py3` = '$data[kondisi_py3]',
        `kondisi_py4` = '$data[kondisi_py4]'
    ...
    public function approval_rilis($data)
    {
        ...
        // VALUES ('$data[no_batch]','$data[no_surat_jalan]','$data[tgl]','$data[id_prc_master_barang]','$data[id_supplier]','$data[op_gudang]','$data[dok_pendukung]','$data[jenis_kemasan]','$data[jml_kemasan]','$data[tutup]','$data[wadah]','$data[label]','$data[qty]','$data[exp]','$data[mfg]',NOW(),'$id_user','0000-00-00 00:00:00','','0','$data[tgl_rilis]')
        // ";
        $sql = "
        UPDATE `tb_lab_hasil_ujitp`
    ...
    {
        $sql = "
        SELECT a.*,b.id_pb,b.no_batch,b.tgl,b.status,b.dok_pendukung,b.op_gudang,b.jenis_kemasan,b.jml_kemasan,b.jml_kemasan,b.qty,b.exp,b.mfg,b.tutup,b.wadah,b.label,c.nama_supplier,d.nama_barang,d.satuan,d.qty_pack FROM tb_lab_hasil_ujitp a
    ...
    {
        $sql = "
        SELECT a.*,b.id_pb,b.no_batch,b.tgl,b.status,b.dok_pendukung,b.op_gudang,b.jenis_kemasan,b.jml_kemasan,b.jml_kemasan,b.qty,b.exp,b.mfg,b.tutup,b.wadah,b.label,c.nama_supplier,d.nama_barang,d.satuan,d.nama_produsen,d.negara_produsen FROM tb_lab_hasil_ujitp a
        LEFT JOIN tb_lab_pemeriksaan_bahan b ON a.id_prc_master_barang = b.id_prc_master_barang
        LEFT JOIN tb_prc_supplier c ON a.id_supplier = c.id_supplier
        LEFT JOIN tb_prc_barang d ON a.id_prc_master_barang = d.id_prc_master_barang
        WHERE a.is_deleted = 0 AND b.no_surat_jalan = '$no_surat_jalan' ORDER BY a.tgl_uji ASC";
