...
class M_hasil_pemeriksaan_pw extends CI_Model
{
    ...
    public function get($id = null)
    {
        ...
        $sql = "
            SELECT a.*,b.jml_bm,b.id_user AS op_gudang,b.no_batch,b.status_barang,c.no_sjl,tgl_dpb, d.nama_barang,d.jenis_barang FROM tb_lab_hasil_ujipewarna a
    ...
    public function update($data)
    {
        ...
        `ident_air` = '$data[ident_air]',
        `ident_hcip` = '$data[ident_hcip]',
        `ident_naohp` = '$data[ident_naohp]',
        `ident_h2so4p` = '$data[ident_h2so4p]',
        `ident_t_larutan` = '$data[ident_t_larutan]',
        `s_pengeringan` = '$data[s_pengeringan]',
        `p_kadar` = '$data[p_kadar]',
        `kesamaan_std` = '$data[kesamaan_std]',
