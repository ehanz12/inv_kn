...
class M_tambah_schedule extends CI_Model
{
    ...
    public function add($data)
    {
        ...
        $sql = "
        INSERT INTO `tb_mkt_schedulemarketing`(`id_customer`, `id_kw_cap`, `id_kw_body`, `no_cr`,`no_batch`,`tgl_sch`,`size`,`mesin`,`jumlah`,`cek_print`, `print`,`tinta`,`jenis_box`,`jenis_zak`,`tgl_kirim`,`keterangan`,`tgl_prd`,`minyak`,`sisa`,`created_at`, `created_by`, `updated_at`, `updated_by`, `is_deleted`) 
