    ...
    public function add()
{
    ...
    public function update()
    {
        ...
        $respon = $this->M_hasil_pemeriksaan_pw->update($data);

        if ($respon) {
            header('location:' . base_url('lab/Hasil_pemeriksaan_lab/Hasil_pemeriksaan_pw') . '?alert=success&msg=Selamat anda berhasil mengupdate Bahan Pewarna');
        } else {
            header('location:' . base_url('lab/Hasil_pemeriksaan_lab/Hasil_pemeriksaan_pw') . '?alert=error&msg=Maaf anda gagal mengupdate Bahan Pewarna');
        }
    }
