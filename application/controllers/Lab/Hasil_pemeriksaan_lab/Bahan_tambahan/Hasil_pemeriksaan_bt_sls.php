...
class hasil_pemeriksaan_bt_sls extends CI_Controller
{
    ...
    function __construct()
    {
        ...
        $this->load->model('M_lab/M_hasil_pemeriksaan/M_bahan_tambahan/M_hasil_pemeriksaan_bt_sls');
    ...
    {
        $data['result'] = $this->M_hasil_pemeriksaan_bt_sls->getsls()->result_array();
        ...
        $this->template->load('template', 'content/lab/hasil_pemeriksaan_bahan_tambahan/hasil_pemeriksaan_bt_sls.php', $data);
    }
    ...
    public function add_ujisls()
    {
        ...
        $data['identifikasi_ss'] = $this->input->post('identifikasi_ss', TRUE);
        $data['kadar'] = $this->input->post('kadar', TRUE);
        ...
        if ($respon) {
            ...
            header('location:' . base_url('lab/pemeriksaan_bahan') . '?alert=error&msg=Maaf anda gagal melakukan Uji Bahan Tambahan (Sodium Launil Sulfat)');
        }
    }
    ...
    public function add()
    {
        ...
        if ($respon) {
            header('location:' . base_url('lab/Hasil_pemeriksaan_lab/Bahan_tambahan/Hasil_pemeriksaan_bt_sls') . '?alert=success&msg=Selamat anda berhasil menambah Barang Masuk Bahan Tambahan');
        } else {
            header('location:' . base_url('lab/Hasil_pemeriksaan_lab/Bahan_tambahan/Hasil_pemeriksaan_bt_sls') . '?alert=error&msg=Maaf anda gagal menambah Barang Masuk Bahan Tambahan');
        }
    }
    ...
    public function update()
    {
        ...
        $respon = $this->M_hasil_pemeriksaan_bt_sls->update($data);

        if ($respon) {
            header('location:' . base_url('lab/Hasil_pemeriksaan_lab/Bahan_tambahan/Hasil_pemeriksaan_bt_sls') . '?alert=success&msg=Selamat anda berhasil melakukan Uji Bahan Tambahan (Sodium Launil Sulfat)');
        } else {
            header('location:' . base_url('lab/Hasil_pemeriksaan_lab/Bahan_tambahan/Hasil_pemeriksaan_bt_sls') . '?alert=error&msg=Maaf anda gagal melakukan Uji Bahan Tambahan (Sodium Launil Sulfat)');
        }
    }
    ...
    public function ditolak()
    {
        ...
        $respon = $this->M_hasil_pemeriksaan_bt_sls->approval_ditolak($data);

        if ($respon) {
            header('location:' . base_url('lab/Hasil_pemeriksaan_lab/Bahan_tambahan/Hasil_pemeriksaan_bt_sls') . '?alert=success&msg=Selamat anda berhasil Reject Bahan Tambahan');
        } else {
            header('location:' . base_url('lab/Hasil_pemeriksaan_lab/Bahan_tambahan/Hasil_pemeriksaan_bt_sls') . '?alert=error&msg=Maaf anda gagal Reject Bahan Tambahan');
        }
    }
    ...
    public function pdf_label_released($no_sj = null)
    {
        ...
        $data['detail'] = $this->M_hasil_pemeriksaan_bt_sls->ambil_label($no_surat_jalan)->result_array();

        $d = $this->load->view('laporan/hasil_pemeriksaan/hasil_pemeriksaan_bt/hasil_pemeriksaan_sodium_launilsulfat/page_released', $data, TRUE);
    ...
    public function pdf_label_reject($no_sj = null)
    {
        ...
        $d = $this->load->view('laporan/hasil_pemeriksaan/hasil_pemeriksaan_bt/hasil_pemeriksaan_sodium_launilsulfat/page_reject', $data, TRUE);
        $mpdf->AddPage("P", "", "", "", "", "15", "15", "5", "15", "", "", "", "", "", "", "", "", "", "", "", "A4");
        $mpdf->WriteHTML($d);
        $mpdf->Output();
    }
    ...
    public function pdf_label_hasil($no_sj = null)
    {
        ...
        $data['detail'] = $this->M_hasil_pemeriksaan_bt_sls->ambil_hasil($no_surat_jalan)->result_array();

        $d = $this->load->view('laporan/hasil_pemeriksaan/hasil_pemeriksaan_bt/hasil_pemeriksaan_sodium_launilsulfat/page_hasil', $data, TRUE);
        $mpdf->AddPage("P", "", "", "", "", "15", "15", "5", "15", "", "", "", "", "", "", "", "", "", "", "", "A4");
        $mpdf->WriteHTML($d);
        $mpdf->Output();
    }
