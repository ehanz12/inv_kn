...
class hasil_pemeriksaan_bt_la extends CI_Controller
{
    ...
    public function update()
    {
        ...
        $respon = $this->M_hasil_pemeriksaan_bt_la->update($data);

        if ($respon) {
            header('location:' . base_url('lab/Hasil_pemeriksaan_lab/Bahan_tambahan/Hasil_pemeriksaan_bt_la') . '?alert=success&msg=Selamat anda berhasil mengupdate Bahan Tambahan (Lecithin Adlec)');
        } else {
            header('location:' . base_url('lab/Hasil_pemeriksaan_lab/Bahan_tambahan/Hasil_pemeriksaan_bt_la') . '?alert=error&msg=Maaf anda gagal mengupdate Bahan Tambahan (Lecithin Adlec)');
        }
    }
