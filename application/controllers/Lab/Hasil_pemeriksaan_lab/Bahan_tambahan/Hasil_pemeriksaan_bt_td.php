...
class hasil_pemeriksaan_bt_td extends CI_Controller
{
    ...
    function __construct()
    {
        ...
        $this->load->model('M_lab/M_hasil_pemeriksaan/M_bahan_tambahan/M_hasil_pemeriksaan_bt_td');
    ...
    {
        $data['result'] = $this->M_hasil_pemeriksaan_bt_td->gettd()->result_array();
        ...
        $this->template->load('template', 'content/lab/hasil_pemeriksaan_bahan_tambahan/hasil_pemeriksaan_bt_td.php', $data);
    }
    ...
    public function add_ujitd()
    {
        ...
        $data['kel_h2so4p'] = $this->input->post('kel_h2so4p', TRUE);
        $data['kel_hcip'] = $this->input->post('kel_hcip', TRUE);
        $data['kel_air'] = $this->input->post('kel_air', TRUE);
        $data['identifikasi'] = $this->input->post('identifikasi', TRUE);
        $data['tio2_h2so4'] = $this->input->post('tio2_h2so4', TRUE);
        $data['s_pengeringan'] = $this->input->post('s_pengeringan', TRUE);
        $data['s_pemijaran'] = $this->input->post('s_pemijaran', TRUE);
        $data['kes_pewarna'] = $this->input->post('kes_pewarna', TRUE);
        ...
        if ($respon) {
            ...
            header('location:' . base_url('lab/pemeriksaan_bahan') . '?alert=error&msg=Maaf anda gagal melakukan Uji Bahan Tambahan (Natrium Benzoat)');
        }
    }
    ...
    public function add()
    {
        ...
        if ($respon) {
            header('location:' . base_url('lab/Hasil_pemeriksaan_lab/Bahan_tambahan/Hasil_pemeriksaan_bt_td') . '?alert=success&msg=Selamat anda berhasil menambah Barang Masuk Bahan Tambahan');
        } else {
            header('location:' . base_url('lab/Hasil_pemeriksaan_lab/Bahan_tambahan/Hasil_pemeriksaan_bt_td') . '?alert=error&msg=Maaf anda gagal menambah Barang Masuk Bahan Tambahan');
        }
    }
    ...
    public function update()
    {
        ...
        $respon = $this->M_hasil_pemeriksaan_bt_td->update($data);

        if ($respon) {
            header('location:' . base_url('lab/Hasil_pemeriksaan_lab/Bahan_tambahan/Hasil_pemeriksaan_bt_td') . '?alert=success&msg=Selamat anda berhasil mengupdate Bahan Tambahan (Natrium Benzoat)');
        } else {
            header('location:' . base_url('lab/Hasil_pemeriksaan_lab/Bahan_tambahan/Hasil_pemeriksaan_bt_td') . '?alert=error&msg=Maaf anda gagal mengupdate Bahan Tambahan (Natrium Benzoat)');
        }
    }
    ...
    public function ditolak()
    {
        ...
        if ($respon) {
            header('location:' . base_url('lab/Hasil_pemeriksaan_lab/Bahan_tambahan/Hasil_pemeriksaan_bt_td') . '?alert=success&msg=Selamat anda berhasil Reject Bahan Tambahan');
        } else {
            header('location:' . base_url('lab/Hasil_pemeriksaan_lab/Bahan_tambahan/Hasil_pemeriksaan_bt_td') . '?alert=error&msg=Maaf anda gagal Reject Bahan Tambahan');
        }
    }
    ...
    public function pdf_label_released($no_sj = null)
    {
        ...
        $data['detail'] = $this->M_hasil_pemeriksaan_bt_td->ambil_label($no_surat_jalan)->result_array();

        $d = $this->load->view('laporan/hasil_pemeriksaan/hasil_pemeriksaan_bt/hasil_pemeriksaan_titanium_dioxide/page_released', $data, TRUE);
    ...
    public function pdf_label_reject($no_sj = null)
    {
        ...
        $d = $this->load->view('laporan/hasil_pemeriksaan/hasil_pemeriksaan_bt/hasil_pemeriksaan_titanium_dioxide/page_reject', $data, TRUE);
        $mpdf->AddPage("P", "", "", "", "", "15", "15", "5", "15", "", "", "", "", "", "", "", "", "", "", "", "A4");
        $mpdf->WriteHTML($d);
        $mpdf->Output();
    }
    ...
    public function pdf_label_hasil($no_sj = null)
    {
        ...
        $data['detail'] = $this->M_hasil_pemeriksaan_bt_td->ambil_hasil($no_surat_jalan)->result_array();

        $d = $this->load->view('laporan/hasil_pemeriksaan/hasil_pemeriksaan_bt/hasil_pemeriksaan_titanium_dioxide/page_hasil', $data, TRUE);
        $mpdf->AddPage("P", "", "", "", "", "15", "15", "5", "15", "", "", "", "", "", "", "", "", "", "", "", "A4");
        $mpdf->WriteHTML($d);
        $mpdf->Output();
    }
