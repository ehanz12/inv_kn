...
class Pewarnaan extends CI_Controller
{
	...
	public function update()
	{
		...
		// echo $respon;
		if ($respon) {
			header('location:' . base_url('melting/Pewarnaan') . '?alert=success&msg=Selamat anda berhasil meng-update Pewarnaan');
		} else {
			header('location:' . base_url('melting/Pewarnaan') . '?alert=error&msg=Maaf anda gagal meng-update Pewarnaan');
		}
	}
